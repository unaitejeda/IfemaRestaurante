...
<body>
    ...
    <?php if (isset($repartidor) && $repartidor['disponibilidad'] == 1): ?>
        ...
        <div class="column pendiente" id="pedidosPendientes">
        ...
        <div class="column" id="pedidosAceptados">
        ...
        <div class="column" id="pedidosRechazados">
